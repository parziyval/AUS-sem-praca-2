...
namespace structures 
{
	...
	Array<T>::Array(const Array<T>& other) :
		vector_(new Vector(*(other.vector_))), // moze byt aj *other.vector lebo operator "." ma vacsiu prioritu ako "*"
		size_(other.size_)
	{
	}
	...
	{
		//int indexV = mapFunction(index); //zistime index vo vectore
		//byte* ptrB = vector_->getBytePointer(indexV); //ukazovatel na indexV-ty prvok vo vectore
		//T* ptrT = reinterpret_cast<T*>(ptrB); //pretypujeme ptrB na ukazovatel T
		//return *ptrT;
